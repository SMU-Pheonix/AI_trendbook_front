...
import ArticleData from '../../mockup_data/article_data.tsx';
import '../../App.css';
                    ...
                    >
                        ...
                        >
                            ...
                            >
                                <div
                                    className="post_tabs"
                                    style={postList === '전체' ? { color: '#E64D3D' } : {}}
                                    onClick={() => {
                                        setPostList('전체');
                                        setCurrentPage(1);
                                    }}
                                ...
                                <div
                                    className="post_tabs"
                                    style={postList === 'AI' ? { color: '#E64D3D' } : {}}
                                    onClick={() => {
                                        setPostList('AI');
                                        setCurrentPage(1);
                                    }}
                                ...
                                <div
                                    className="post_tabs"
                                    style={postList === '주식' ? { color: '#E64D3D' } : {}}
                                    onClick={() => {
                                        setPostList('주식');
                                        setCurrentPage(1);
                                    }}
                                ...
                                <div
                                    className="post_tabs"
                                    style={postList === '스포츠' ? { color: '#E64D3D' } : {}}
                                    onClick={() => {
                                        setPostList('스포츠');
                                        setCurrentPage(1);
                                    }}
